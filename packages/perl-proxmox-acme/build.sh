#!/bin/bash
# build.sh — perl-proxmox-acme (Layer 0: Perl leaf module, no PVE deps)
#
...
# ------------------------------------------------------------------
# 2. Build the Perl module (pure Perl, Proxmox ACME client)
# ------------------------------------------------------------------
...
echo "Proxmox::ACME — ACME client library for Proxmox" > "$STAGE/meta/description"
