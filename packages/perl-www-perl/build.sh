#!/bin/bash
# build.sh — perl-www-perl (Layer 0: Perl leaf module, no PVE deps)
#
...
# ------------------------------------------------------------------
# 2. Build the Perl module (pure Perl, libwww-perl)
# ------------------------------------------------------------------
...
echo "libwww-perl — the World-Wide Web library for Perl" > "$STAGE/meta/description"
