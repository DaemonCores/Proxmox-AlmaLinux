#!/bin/bash
# build.sh — perl-json (Layer 0: Perl leaf module, no PVE deps)
#
...
# ------------------------------------------------------------------
# 2. Build the Perl module (XS — compiled for speed)
# ------------------------------------------------------------------
...
echo "JSON — JSON encoding and decoding for Perl" > "$STAGE/meta/description"
