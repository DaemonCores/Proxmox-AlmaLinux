#!/bin/bash
# build.sh — perl-data-dumper (Layer 0: Perl leaf module, no PVE deps)
#
...
# ------------------------------------------------------------------
# 2. Build the Perl module (XS — compiled)
# ------------------------------------------------------------------
...
echo "Data::Dumper — stringified perl data structures" > "$STAGE/meta/description"
