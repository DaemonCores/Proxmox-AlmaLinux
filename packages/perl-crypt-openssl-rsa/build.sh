#!/bin/bash
# build.sh — perl-crypt-openssl-rsa (Layer 0: Perl leaf module, no PVE deps)
#
...
REPO_URL="git://git.proxmox.com/git/perl-crypt-openssl-rsa.git"
...
# ------------------------------------------------------------------
# 2. Build the Perl module (XS — compiled, needs OpenSSL)
# ------------------------------------------------------------------
...
echo "Crypt::OpenSSL::RSA — RSA encoding and decoding using OpenSSL" > "$STAGE/meta/description"
