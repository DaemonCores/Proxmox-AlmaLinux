#!/bin/bash
# build.sh — perl-crypt-openssl-rsa (Layer 0: Perl git module, no PVE deps)
#
# Build pipeline:
...
REPO_URL="https://git.proxmox.com/git/perl-crypt-openssl-rsa.git"
PKG_DESCRIPTION="Crypt::OpenSSL::RSA - RSA encoding/decoding for Perl"
