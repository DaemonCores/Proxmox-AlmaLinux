#!/bin/bash
# build.sh — perl-http-daemon (Layer 0: Perl leaf module, no PVE deps)
#
...
REPO_URL="git://git.proxmox.com/git/perl-http-daemon.git"
...
# ------------------------------------------------------------------
# 2. Build the Perl module (pure Perl)
# ------------------------------------------------------------------
...
echo "HTTP::Daemon — simple http server class" > "$STAGE/meta/description"
