#!/bin/bash
# build.sh — perl-posixstrptime (Layer 0: Perl leaf module, no PVE deps)
#
# POSIX::strptime — Perl XS interface to POSIX strptime function.
# CPAN-sourced: https://metacpan.org/pod/POSIX::strptime
#
...
CPAN_URL="https://www.cpan.org/authors/id/G/GO/GOZER/POSIX-strptime-0.13.tar.gz"
...
mv "/tmp/src/POSIX-strptime-0.13" "$WORKDIR"
cd "$WORKDIR"

# ------------------------------------------------------------------
# 2. Build the Perl module (XS — compiled, needs C library)
# ------------------------------------------------------------------
...
echo "POSIX::strptime — Perl XS interface to strptime(3)" > "$STAGE/meta/description"
