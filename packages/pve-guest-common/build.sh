#!/bin/bash
# build.sh — pve-guest-common (Layer 2: Perl, guest agent common code)
#
# Common Perl modules for PVE guest agents and guest-related functionality.
...
REPO_URL="git://git.proxmox.com/git/pve-guest-common.git"
...
echo "PVE guest-related Perl modules — common code for guest agents" > "$STAGE/meta/description"
