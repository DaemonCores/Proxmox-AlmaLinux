#!/bin/bash
# build.sh — perl-linux-inotify2 (Layer 0: Perl leaf module, no PVE deps)
#
...
# ------------------------------------------------------------------
# 2. Build the Perl module (XS — compiled, Linux inotify interface)
# ------------------------------------------------------------------
...
echo "Linux::Inotify2 — scalable file change notification for Linux" > "$STAGE/meta/description"
