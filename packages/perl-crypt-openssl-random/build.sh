#!/bin/bash
# build.sh — perl-crypt-openssl-random (Layer 0: Perl leaf module, no PVE deps)
#
...
echo "Crypt::OpenSSL::Random — OpenSSL random number generator for Perl" > "$STAGE/meta/description"
